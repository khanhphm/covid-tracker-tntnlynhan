...
window.onload = async () => {
    ...
    swal({
        title:"Chú Ý",
        icon: "warning",
        text:" Do hệ thống API của WHO dừng cung cấp dữ liệu về số ca khỏi bệnh của các quốc gia nên các dữ liệu liên quan như tỉ lệ khỏi bệnh thể sẽ bị sai. Chúng tôi sẽ sớm khắc phục lỗi này, mong mọi người thông cảm"
    });
